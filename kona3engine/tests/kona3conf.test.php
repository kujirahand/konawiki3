...
test_eq(__LINE__, $flat_items['ai_shortcut_complete']['default'], 'Ctrl+N', "設定項目定義: AI文章補完ショートカット");
test_eq(__LINE__, $flat_items['ai_shortcut_spellcheck']['default'], 'Ctrl+J', "設定項目定義: AI誤字脱字修正ショートカット");
