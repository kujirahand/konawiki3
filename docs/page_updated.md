...
イベントの登録は [kona3engine/kona3page_updated.inc.php](file:///Users/kujirahand/repos/konawiki3/kona3engine/kona3page_updated.inc.php) で行われ、KonaWiki3 の初期化時に自動で読み込まれます。

---

## フック API

共通ライブラリ [kona3engine/kona3lib.inc.php](file:///Users/kujirahand/repos/konawiki3/kona3engine/kona3lib.inc.php) にて、以下のグローバル関数が提供されています。
...
[kona3engine/kona3page_updated.inc.php](file:///Users/kujirahand/repos/konawiki3/kona3engine/kona3page_updated.inc.php) では、初期状態で以下の3つのフックが `write` イベントに登録されています。
